import {FETCH_STACKS, FETCH_CARD, FETCH_MY_STACK_OVERVIEW, FETCH_MY_RECENT_STACKS, FETCH_STACK_OVERVIEW, FETCH_MY_COMMUNITY_STACKS, CREATE_STACK, SEARCH_STACKS, COPY_STACK} from '../actions/types';
const default_state ={
    all: [],
    subj: "",
    course: "",
