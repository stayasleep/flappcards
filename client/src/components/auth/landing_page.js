...
class landing extends Component {
    render (){
        return (
            <div>
                <AppBar style={styles.header} title={<span style={styles.title}>FlappCards</span>} showMenuIconButton={false} iconElementRight={<RecoverPw/>} iconElementRight={<LoginModal/>}  />
