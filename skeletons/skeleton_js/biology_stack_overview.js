...
function makeCards(cardObject) {
    ...
    cardTitleDiv.className = 'mdl-card__title mdl-card--expand'; // <div class="mdl-card__title">
    ...
    let studyCardDiv = document.createElement('div');
    studyCardDiv.className = 'mdl-card__actions mdl-card--border';
